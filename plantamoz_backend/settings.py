...
# No Render, a URL pública vem automática; garante host e CSRF mesmo sem domínio custom.
RENDER_EXTERNAL_URL = os.getenv('RENDER_EXTERNAL_URL', '').strip()
if RENDER_EXTERNAL_URL:
    from urllib.parse import urlparse
    _render_host = urlparse(RENDER_EXTERNAL_URL).hostname
...
ROOT_URLCONF = 'plantamoz_backend.urls'
